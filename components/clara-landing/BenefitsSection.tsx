...
export default function BenefitsSection() {
  ...
  return (
    <section
      id="benefits"
      ref={benefitsRef}
      className={`py-16 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-white via-[#cbbbef]/10 to-[#81aaef]/20 relative transition-all duration-1000 ${benefitsInView ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}
    >
